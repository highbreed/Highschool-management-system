...
class MarkingPeriod(models.Model):
	...
	def get_school_days(self):
		school_days_list = []
		if self.monday == 'True':
			school_days_list.append(self.monday)
		if self.tuesday == 'True':
			school_days_list.append(self.tuesday)
		if self.wednesday == 'True':
			school_days_list.append(self.wednesday)
		if self.thursday == 'True':
			school_days_list.append(self.thursday)
		if self.friday == 'True':
			school_days_list.append(self.friday)
		if self.saturday == 'True':
			school_days_list.append(self.saturday)
		if self.sunday== 'True':
			school_days_list.append(self.sunday)
